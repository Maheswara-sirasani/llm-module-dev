...
NEWS_API_URL = "https://newsapi.org/v2/everything?q=tesla&from=2025-05-14&sortBy=publishedAt&apiKey=850bef017d85491ca228452a0808842e"
API_KEY = "850bef017d85491ca228452a0808842e"
HEADLINE_COUNT = 5
ARTICLE_COUNT = 2
...
def process_news_articles(news_articles, output_file="ZPMJ-10114_Maheswara_Reddy_Sirasani_response.json"):
    final_output = {
        "status": "ok",
        "news_articles": []
    }
...
if __name__ == "__main__":
    try:
        ...
        process_news_articles(articles, output_file="ZPMJ-10114_Maheswara_Reddy_Sirasani_response.json")
